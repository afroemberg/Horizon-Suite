...
L["TALKING_HEAD_SUBTITLE_ONLY"]                               = "Subtitle Only"
L["TALKING_HEAD_SUBTITLE_ONLY_DESC"]                          = "Hide the portrait only; skin styling still applies if enabled."
...
L["TALKING_HEAD_NAME_SIZE_DESC"]                              = "Font size for the NPC name (10–20)."
...
L["TALKING_HEAD_TEXT_SIZE_DESC"]                              = "Font size for NPC dialogue text (10–24)."
L["TALKING_HEAD_PREVIEW"]                                     = "Preview"
L["TALKING_HEAD_PREVIEW_DESC"]                                = "Preview the current Talking Head style."
