...
L["INSIGHT_REALM_NAMES_SIMPLIFY"]                             = "Simplify"
...
L["INSIGHT_DISPLAY_MODE_FORCE_SHOW"]                          = "Force Show"
...
L["INSIGHT_MYTHIC_SCORE_MODE_DESC"]                           = "Choose when to show Mythic+ score. Force Show always displays it. Modifier shows it only while Shift is held."
L["INSIGHT_ITEM_LEVEL_MODE_DESC"]                             = "Choose when to show equipped item level. Force Show requests inspect data on hover and may not appear instantly. Modifier shows it only while Shift is held."
L["INSIGHT_HONOR_LEVEL_MODE_DESC"]                            = "Choose when to show PvP honor level. Force Show attempts to show it on every player tooltip. Modifier shows it only while Shift is held."
